<template>
  <q-page ref="pageChat" class="page-chat flex column">
    <q-banner
      ...
      class="bg-grey-4 text-center fixed-top">{{otherUserDetails.name}} is offline.
    </q-banner>
    ...
    <q-footer elevated>
      <q-toolbar>
        <q-form @submit="sendMessage" class="full-width">
          <q-input v-model="newMessage" ref="newMessage" bg-color="white" rounded outlined label="Message" dense>
